...
const coefficients: Array<[number, number, number, number]> = [
  ...
  [1, .95, .7, .55], [1, .75, .45, .55], [1, .7, .25, .15], [.75, 1, .35, .25],
...
const texts: Array<[string, string, string, string, string]> = [
  ['过去大半年，真要挑一个项目给自己撑场面，你选：', '就那个，核心那块真是我扛的', '团队做的，但最难那段是我的', '项目不少，一时还真挑不出哪个能撑场面', '就那个，折腾最久，至少记得最清楚'],
  ['项目突然炸了，刚好这块你最懂。你先：', '先救火，锅可以晚点分', '拉群，把能打的都叫进来', '先问清楚，这事儿现在归谁管', '翻记录，找“问题不大”的出处'],
  ['领导在群里只回了一个“？”。你：', '补三行结论，当刚才没发生', '先问同事：这个问号什么意思', '盯着它研究了一会儿语气', '第一次意识到标点符号也有职级'],
  ['你突然休假一个月，部门大概会：', '至少有个项目先暂停思考', '人休假了，微信没有', '交接完还能跑，文明社会', '第三周群里问：“这事谁管？”'],
  ['别人最常因为什么来找你？', '“这事你帮我判断一下。”', '“这个你最熟，你先看看。”', '“你跟那边熟不熟？”', '“三年前那个文件，你这儿还有吧？”'],
  ['同事说：“这个很简单，你顺手弄一下。”你：', '先问清楚，到底有多简单', '嘴上说好，已经开始排时间了', '行，新的岗位职责就这么口头生效了', '笑着说“我看看”，文件夹已经建好了'],
  ['周五下班前十分钟，突然有人@你：“今天能出吗？”', '先问清楚，真急就先做关键部分', '回“收到”，给自己争取三分钟', '看到“今天”两个字，先喝了口水', '心里已经开始给周末办退票'],
  ...
  ['你发现自己的想法，被别人拿去汇报了。你：', '当面说“挺好，能落地就行”，表情也挺自然', '回去把聊天记录往上翻三页', '周报里重新写一遍，正式一点', '决定下次想法先说七成'],
  ...
  ['优秀名额只够一个，几个人表现都不错。你觉得：', '领导会上真会替我抢一抢', '会替我说话，剩下看现场', '大家都很好，只是名额不同意', '“你今年其实真的做得很好……”'],
  ['绩效季，领导突然发来：“下午有空吗？聊两句。”你：', '回“有”，下午再说', '顺手把这大半年的重点项目过一遍', '开始考古他最近的语气', '打开招聘软件。\n但只是随便看看。'],
]
