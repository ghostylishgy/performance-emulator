...
const rows: Array<[PersonaId, PersonaId, string, string]> = [
  ...
  ['result_captioner','result_captioner','双人发布会','同一个项目，你俩能在各自的周报里，分别写出两个拯救大盘的主角。'],
  ...
  ['result_captioner','org_weather_station','风向字幕组','领导还没把嘴张开，气象台已经递了眼色，字幕师的下一版战略 PPT 已经修改到了“致谢”页。'],
  ...
  ['reality_patcher','reality_patcher','临时方案永久化','三个月前那个“先凑合一下”，现在已经成为正式流程。'],
  ...
  ['org_weather_station','stable_worker','气象值班组','一个每天在工位上感知风云变幻，另一个雷打不动把手里的活干完。暴风雨来了，牛马还在帮气象台点外卖。'],
